...
#define pulso 22
// #define led 2
#define grupo_1 GPIO_NUM_2
#define grupo_2 GPIO_NUM_0
#define grupo_3 GPIO_NUM_4
#define grupo_4 GPIO_NUM_15
...
void initIrs(void){
    ...
    pGIOConfig.pull_down_en = GPIO_PULLDOWN_ENABLE; /*!< GPIO pull-down   
                                        */
    // pGIOConfig.intr_type = GPIO_INTR_NEGEDGE; 
    pGIOConfig.intr_type = GPIO_INTR_POSEDGE;
...
void app_main(void)
{
    initIrs();
    init_uart();
    configPin(pin_4, pin_5, pin_6);
    configPinMedicion(pin_1, pin_2, pin_3);
    confPinRele(grupo_1, grupo_2, grupo_3, grupo_4);
    configAdc();
    configAdc2();
    // setTimer();
    wifi_init_sta();
    ...
    while (1)
    {
        ...
        //cambio de grupos para el modulo de rele
        if (strcmp(valor, "P3I") == 0)
        {
            activarGrupoBateo(1);
            eraserGb();
        }
        
        if (strcmp(valor, "P3AI") == 0)
        {
            activarGrupoBateo(2);
            eraserGb();
        }

        if (strcmp(valor, "P4I") == 0)
        {
            activarGrupoBateo(3);
            eraserGb();
        }
        if (strcmp(valor, "P4AI") == 0)
        {
            activarGrupoBateo(4);
            eraserGb();

        }
        if ((strcmp(valor, "P4AO") == 0) || (strcmp(valor, "P4O") == 0) || (strcmp(valor, "P3AO") == 0) || strcmp(valor, "P3O") == 0)
        {
            activarGrupoBateo(5);
            eraserGb();
        }
        ...
        if (strcmp(valor, "gm") == 0)
        {
            ...
            if (pot == 5)
            {
                ESP_LOGI(TAG3,"entro en leer sensores");
                pot = 1;
